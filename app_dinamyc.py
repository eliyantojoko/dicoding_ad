...
@st.cache_data
def load_data():
    df = pd.read_csv("https://raw.githubusercontent.com/eliyantojoko/dicoding_ad/refs/heads/main/cleaned_and_joined_data_2017_Jan_Aug.csv", parse_dates=["order_purchase_timestamp"])
